...
import com.torchmind.lithium.communication.serialization.NetworkSerializable;
...
public interface Buffer {
        ...
        /**
         * Returns a single big integer value from the buffer and increases its reader index by the amount required to
         * store its value as designated by the amount of bits the instance reports.
         *
         * @return an integer.
         *
         * @see BigInteger#bitLength() for an exact measurement of size.
         */
        @Nonnull
        ...
        /**
         * Retrieves a special serialization value from this buffer using its encoded form and increases its reader index by
         * the amount required to store the value.
         *
         * @param type a reference to the serialization value implementation type.
         * @param <V>  a serialization value type.
         ...
         * @throws IndexOutOfBoundsException when there is not enough data left within this buffer to de-serialize the supplied serialization type.
         */
        @Nonnull
        <V extends NetworkSerializable> V readObject(@Nonnull Class<V> type) throws IllegalArgumentException, IllegalStateException, IndexOutOfBoundsException;
        ...
        /**
         * Writes a single big integer value into the buffer and increases its writer index by the amount required to
         * store its value as designated by the amount of bits the instance reports.
         *
         * This method returns a reference to its parent instance and is thus chain-able.
         *
         ...
         */
        @Nonnull
        Buffer writeBigInteger(@Nonnull BigInteger integer);
        ...
        /**
         * Writes a special serialization value into the buffer using its encoded form and increases its writer index by the
         * amount required to store the value.
         *
         * This method returns a reference to its parent instance and is thus chain-able.
         *
         * @param value a serialization value.
         * @return a reference to this buffer.
         *
         * @throws IllegalArgumentException when the supplied type does not provide at least one constructor for decoding.
         * @throws IOException              when the supplied serialization value implementation type reports an error during serialization.
         */
        @Nonnull
        Buffer writeObject(@Nonnull NetworkSerializable value) throws IllegalArgumentException, IOException;
